...
const hpMcW8 = {
  string: "D\xE9finir comment les utilisateurs peuvent naviguer dans votre magasin"
};
const ivJ1qt = {
  string: "G\xE9rez vos groupes de permissions et leurs permissions"
};
const n0RwMK = {
  string: "D\xE9finir les types de produits vendu"
};
const zxs6G3 = {
  string: "G\xE9rer les moyens de livraisons"
};
const RQUkVW = {
  string: "G\xE9rer vos employ\xE9s et leurs permissions"
};
const EIULpW = {
  string: "G\xE9rer les taxes de votre magasin"
};
const m19JfL = {
  string: "Visualiser et mettre \xE0 jour vos plugins et leurs param\xE8tres "
};
const yJynYK = {
...
const wWTUrM = {
  string: "Aucune activit\xE9 trouv\xE9e"
};
const zWgbGg = {
  string: "Aujourd'hui"
};
...
const aCX8rl = {
  context: "subheader",
  string: "Voici les informations que nous avons r\xE9unies \xE0 propos de votre magasin"
};
const rr8fyf = {
  context: "header",
...
const Q1Uzbb = {
  string: "Aucun produit trouv\xE9"
};
const G7mu0y = {
  string: "L'API GraphQL est de qualit\xE9 b\xEAta. Elle n'est pas compl\xE9tement optimis\xE9e et certaines mutations ou requ\xEAtes peuvent \xEAtre manquantes."
};
const QBxN6z = {
...
const E54eoT = {
  string: " La cr\xE9ation de la structure de navigation se fait par glisser-d\xE9poser. Cr\xE9ez simplement un nouvel \xE9l\xE9ment de menu, puis faites-le glisser \xE0 sa place. Vous pouvez d\xE9placer des \xE9l\xE9ments les uns dans les autres pour cr\xE9er une arborescence et faire glisser les \xE9l\xE9ments de haut en bas pour cr\xE9er une hi\xE9rarchie."
};
const H3Uirw = {
...
const Uf3oHA = {
  ...
  string: "Cr\xE9er un nouvel article"
};
const dEUZg2 = {
  context: "header",
...
const WwZfNK = {
  string: "Ajouter un \xE9l\xE9ment pour commencer la cr\xE9ation du menu"
};
const ugnggZ = {
  string: "Menu cr\xE9\xE9"
};
const bj1U23 = {
  string: "\xCAtes-vous certain de vouloir effacer {menuName}?"
};
const DWs4ba = {
  string: "Aucun menu trouv\xE9"
};
const JXRYQg = {
  context: "button",
  string: "Cr\xE9er menu"
};
const MTl5o6 = {
...
const saKXY3 = {
  ...
  string: "Non publi\xE9e"
};
const YI6Fhj = {
  context: "no address is set in draft order",
  string: "Pas d\xE9fini"
};
const PX2zWy = {
...
const BftZHy = {
  ...
  string: "Cr\xE9er le type de page"
};
const W5SK5c = {
  string: "S\xE9lectionnez le type de contenu"
};
const gz9v22 = {
...
const SSWFo8 = {
  context: "window title",
  string: "Cr\xE9er un type de produit"
};
const bq1eEx = {
  context: "header",
  string: "Cr\xE9er un type de produit"
...
const ppLwx3 = {
  ...
  string: "Cat\xE9gories ({quantit\xE9})"
};
const QdGzUf = {
...
const yOaNWB = {
  ...
  string: "\xCAtes-vous certain de vouloir effacer {name}?"
};
const LsgHmZ = {
...
const USO8PB = {
  ...
  string: "Application d\xE9sactiv\xE9e"
};
const YHNozE = {
  context: "dialog header",
  string: "Activate App"
...
const zQX6xO = {
  context: "dialog header",
  string: "Supprimer l'application"
};
const whTEcF = {
  context: "link",
  string: "D\xE9sactiver"
};
const Go50v2 = {
...
const VsGcdP = {
  context: "section header",
  string: "Permissions de l'application"
};
const jDIRQV = {
  context: "section header",
...
const WnlZMO = {
  context: "title",
  string: "Il y a un probl\xE8me avec l'application."
};
const k5lHFp = {
...
const PkCmGU = {
  ...
  string: "Installer l'application"
};
const Id7C0X = {
  context: "section header",
...
const D4nzdD = {
  ...
  string: "Donner tous les acc\xE8s au magasin pour cette application"
};
const flP8Hj = {
...
const GjH9uy = {
  context: "header",
  string: "Cr\xE9er une nouvelle application"
};
const Kxiige = {
  string: "Cl\xE9 d'acc\xE8s g\xE9n\xE9r\xE9e"
};
const DGCzal = {
  string: "Cette cl\xE9 vous donne acc\xE8s \xE0 l'API de votre magasin et vous la trouverez l\xE0: {url}"
};
const r86alc = {
  context: "button",
  string: "Copi\xE9"
...
const ixjvkM = {
  string: "Nous avons cr\xE9\xE9 votre cl\xE9 d'acc\xE8s par d\xE9faut. Assurez-vous de copier votre nouvelle cl\xE9 d'acc\xE8s personnelle maintenant. Vous ne pourrez plus la voir ensuite. "
};
const imYxM9 = {
  context: "header",
  string: "Informations de l'application"
};
const foNlhn = {
...
const bsP4f3 = {
  string: "Aucune cl\xE9 d'acc\xE8s trouv\xE9e"
};
const RMB6fU = {
  context: "button",
  string: "Cr\xE9er une cl\xE9 d'acc\xE8s"
};
const VHuzgq = {
...
const XB2Jj9 = {
  ...
  string: "Cr\xE9er une application"
};
const voRaz3 = {
...
const NskBjH = {
  ...
  string: "Le Marketplace sera bient\xF4t disponible"
};
const wxFwUW = {
  context: "marketplace button",
  string: "Visiter le Marketplace"
};
const LATpSE = {
  context: "marketplace content",
  string: "D\xE9couvrez des applications gratuites et payantes dans notre Marketplace Saleor"
};
const k0rGBI = {
  string: "Les cl\xE9s d'acc\xE8s sont utilis\xE9es pour authentifier les comptes service "
};
const t9a9GQ = {
  string: "Vous avez cr\xE9\xE9 une cl\xE9 d'acc\xE8s. Assurez-vous de copier votre nouvelle cl\xE9 d'acc\xE8s personnelle maintenant. Vous ne pourrez plus la voir ensuite. "
};
const T5nU7u = {
  context: "header",
  string: "Cr\xE9er une cl\xE9 d'acc\xE8s"
...
const quV5zH = {
  ...
  string: "Supprimer la cl\xE9 d'acc\xE8s"
};
const ZprV2g = {
...
const uIPD1i = {
  ...
  string: "L'application a \xE9t\xE9 supprim\xE9e"
};
const agZQkB = {
  context: "window title",
  string: "Cr\xE9er une application"
...
const eWV760 = {
  string: "L'attribut avec ce slug existe d\xE9j\xE0"
};
const rKf4LU = {
  context: "dialog title",
...
const h1rPPg = {
  ...
  string: "\xCAtes-vous certain de vouloir supprimer {attributeName}?"
};
const jBu2yj = {
...
const Q7uuDr = {
  ...
  string: "Ceci est utilis\xE9 en interne. Assurez-vous de ne pas utiliser d'espaces"
};
const l5V0QT = {
...
const oIvtua = {
  ...
  string: "Type d'entr\xE9e de catalogue pour le propri\xE9taire de magasin"
};
const ZayvsI = {
...
const IGvQ8k = {
  context: "button",
  string: "Cr\xE9er un attribut"
};
const rvk9ls = {
  context: "attribute can be used only in variants",
  string: "Variantes uniquement"
};
const HQR2y0 = {
...
const ztQgD8 = {
  string: "Aucun attribut trouv\xE9"
};
const yKuba7 = {
...
const jswILH = {
  ...
  string: "Ajouter \xE0 la colonne Options "
};
const AzMSmb = {
  context: "caption",
  string: "Si activ\xE9, cet attribut peut \xEAtre utilis\xE9 entant que colonne dans la table de produit"
};
const lCxfDe = {
  context: "attribute properties regarding dashboard",
  string: "Propri\xE9t\xE9 du tableau de bord"
};
const Q9wTrz = {
  context: "caption",
  string: "Si activ\xE9, vous pourrez utiliser cet attribut pour filtrer les produits dans la liste des produits"
};
const AgY5Mv = {
  context: "attribute properties regarding storefront",
  string: "Propri\xE9t\xE9s de la boutique"
};
const cJ5ASN = {
  context: "attribute position in storefront filters",
  string: "Position dans la navigation \xE0 facettes"
};
const h2Hta6 = {
  context: "caption",
...
const JyQoES = {
  ...
  string: '\xCAtes-vous certain de vouloir supprimer la valeur "{name}"?'
};
const WWV8aZ = {
  context: "dialog title",
...
const no3Ygn = {
  string: `\xCAtes-vous certain de vouloir supprimer la valeur "{name}"? Si vous la supprimez, vous ne pourrez l'assigner \xE0 aucun autre produit avec l'attribut "{attributeName}".`
};
const XYhE8p = {
...
const H60H6L = {
  ...
  string: "Vue par d\xE9faut du magasin"
};
const g5zIpS = {
  context: "No attribute values found",
  string: "Aucune valeur trouv\xE9e"
};
const J3uE0t = {
  context: "section header",
...
const xVn5B0 = {
  ...
  string: "La nouvelle valeur a \xE9t\xE9 ajout\xE9e"
};
const lw9WIk = {
  context: "deleted multiple attributes",
  string: "Attributs supprim\xE9s avec succ\xE8s"
};
const vzgZ3U = {
  context: "card header",
  string: "Sign In"
...
const tTtoKd = {
  context: "error message",
  string: "D\xE9sol\xE9, votre pseudo et/ou mot-de-passe sont incorrects. Merci d'essayer \xE0 nouveau."
};
const ChGI4V = {
  context: "error message",
...
const S22jIs = {
  context: "button",
  string: "D\xE9finir un nouveau mot-de-passe"
};
const WhKGPA = {
  context: "page title",
...
const C0JLNW = {
  string: "L'adresse e-mail fournie n'existe pas dans notre base de donn\xE9es. "
};
const hOxIeP = {
  string: "Disponibilit\xE9"
};
const dOQB9o = {
...
const wQdR8M = {
  string: "Ajouter un titre et une description pour les moteurs de recherche pour rendre cette cat\xE9gorie plus facile \xE0 trouver"
};
const xo5UIb = {
  context: "dialog title",
  string: "Effacer la cat\xE9gorie"
};
const dJQxHt = {
  context: "delete category",
  string: "\xCAtes-vous certain de vouloir effacer #{categoryName}?"
};
const vEYtiq = {
  string: "Nom de la cat\xE9gorie"
};
const vof5TR = {
  context: "button",
  string: "Cr\xE9er une cat\xE9gorie"
};
const JiXNEV = {
  string: "Rechercher la cat\xE9gorie"
};
const vy7fjd = {
  context: "tab name",
  string: "Toutes les cat\xE9gories"
};
const dM86a2 = {
  string: "Aucune cat\xE9gorie trouv\xE9e"
};
const rrbzZt = {
  string: "Aucune sous-cat\xE9gorie trouv\xE9e"
};
const BHQrgz = {
  context: "number of subcategories",
  string: "Sous cat\xE9gories"
};
const k8ZJ5L = {
  context: "number of products",
  string: "Num\xE9ro des produits"
};
const VQLIXd = {
  context: "product",
  string: "Nom"
...
const NivJal = {
  context: "section header",
  string: "Toutes les sous-cat\xE9gories"
};
const UycVMp = {
  context: "button",
  string: "Cr\xE9er une sous-cat\xE9gorie "
};
const Irflxf = {
  context: "window title",
  string: "Cr\xE9er une cat\xE9gorie"
...
const xl7Fag = {
  string: "Date de cr\xE9ation de la cat\xE9gorie"
};
const HvJPcU = {
  string: "Cat\xE9gorie supprim\xE9e"
};
const KCjd1o = {
  context: "dialog title",
...
const sG0w22 = {
  context: "dialog title",
  string: "Supprimer les cat\xE9gories"
};
const xRkj2h = {
  string: "\xCAtes-vous certain de vouloir effacer #{categoryName}?"
};
...
const Rj8LxK = {
  string: "Ajouter un titre et une description pour les moteurs de recherche pour rendre cette collection plus facile \xE0 trouver"
};
const Fxa6xp = {
  context: "page header",
...
const jyaAlB = {
  context: "button",
  string: "Cr\xE9er une collection"
};
const lL3YJO = {
  context: "collection",
  string: "Publi\xE9"
...
const Q8wHwJ = {
  string: "Collection supprim\xE9e"
};
const MxhVZv = {
  string: "\xCAtes-vous certain de vouloir supprimer l'image de collection?"
};
const I1Mz7h = {
  string: "Manage Collection Channel Availability"
};
const pVFoOk = {
  string: "\xCAtes-vous certain de vouloir effacer #{collectionName}?"
};
const ttMauu = {
  context: "window title",
  string: "Cr\xE9er une collection"
...
const yT5zvU = {
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer cette collection?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} collections?}}"
};
const Ykw8k5 = {
  context: "dialog title",
...
const MVU6ol = {
  ...
  string: "Les permissions de ce groupe d\xE9passent les v\xF4tres. Vous ne pouvez g\xE9rer que les permissions dont vous disposez."
};
const VmMDLN = {
...
const AuwpCm = {
  string: "R\xE9gion du pays"
};
const PkjQS6 = {
  context: "description",
  string: "Aucun r\xE9sultat trouv\xE9"
};
const fP9FXB = {
  context: "input label",
...
const sf6FMK = {
  ...
  string: "Recherchez par nom de cat\xE9gorie, etc..."
};
const XLYssG = {
...
const U3BQKA = {
  string: "D\xE9finir la date de publication"
};
const tQuE1q = {
...
const UaYJJ8 = {
  string: "\xCAtes-vous certain de vouloir effacer la tabulation de recherche {name}?"
};
const LmKz3g = {
  string: "Boutique"
};
...
const DEa1T1 = {
  context: "button",
  string: "Sauvegarder la recherche"
};
const zSOvI0 = {
  string: "Filtres"
};
...
const MPOj0I = {
  ...
  string: "Sauvegarder les modifications"
};
const FWWliu = {
...
const NxeDbG = {
  ...
  string: "D\xE9placer les images ici pour les t\xE9l\xE9charger"
};
const LkuDEb = {
...
const BooQvo = {
  context: "navigator placeholder",
  string: "Appuyez sur {key} pour voir les actions disponibles"
};
const AOI4LW = {
  context: "navigator placeholder",
  string: "Chercher dans le catalogue"
};
const YYkkhx = {
  context: "navigator section header",
  string: "Naviguer vers"
};
const me585h = {
  context: "navigator section header",
  string: "Actions rapides"
};
const Gxm7Qx = {
  context: "navigator notification title",
  string: "La navigateur est l\xE0 pour vous aider"
};
const ccXLVi = {
  string: "Cat\xE9gorie"
};
...
const cfQf0w = {
  context: "button",
  string: "Cr\xE9er une commande"
};
const V1mqpZ = {
  context: "button",
  string: "Cr\xE9er un groupe de permissions"
};
const JFmOfi = {
  context: "button",
  string: "Cr\xE9er produit"
};
const y9cvqE = {
  context: "button",
  string: "Cr\xE9er un bon d'achat"
};
const IyHQr0 = {
  context: "navigator action",
  string: "Aller \xE0 la commande #{orderNumber}"
};
const kbkjEc = {
...
const iAvKNf = {
  ...
  string: "Afficher l'aide"
};
const usSkzP = {
  context: "navigator order mode description",
  string: "Chercher une commande"
};
const k8bltk = {
  string: "Aucun r\xE9sultat"
};
...
const fNFEkh = {
  string: "Num\xE9ro de lignes:"
};
const liLrVs = {
  context: "save filter tab, header",
  string: "Enregistrer la recherche personnalis\xE9e "
};
const QcIFCs = {
...
const TGX4T1 = {
  string: "Pr\xE9visualisation pour moteur de recherche"
};
const IoDlcd = {
  string: "Slug"
};
const ChAjJu = {
  ...
  string: "{numberOfCharacters} sur {maxCharacters} caract\xE8res"
};
const zyXcBP = {
...
const qLbse5 = {
  context: "button",
  string: "D\xE9connexion"
};
const akXDST = {
  context: "section header",
  string: "Visibilit\xE9"
};
const qMB6d2 = {
  context: "weight",
...
const gTr0qE = {
  string: "Param\xE8tres de livraison"
};
const HjXnIf = {
  string: "Content Management"
};
const jFrdB5 = {
  string: "Param\xE8tres du produit"
};
const MWSacl = {
  string: "Multichannel"
};
...
const kErneR = {
  string: "Ce client n'a aucune adresse ajout\xE9e \xE0 son livret d'adresses. Vous pouvez ajouter une adresse en cliquant sur le bouton ci-dessous."
};
const n5vskv = {
...
const hMRP6J = {
  string: "Adresse par d\xE9faut"
};
const VyzsWZ = {
  string: "Adresse de facturation par d\xE9faut"
};
const nLML8Y = {
  string: "Adresse d'envoi par d\xE9faut"
};
const puikeb = {
  context: "button",
...
const hLOEeb = {
  context: "button",
  string: "D\xE9finir comme adresse de facturation par d\xE9faut"
};
const BfJGij = {
  context: "header",
...
const w3sGrD = {
  string: "Entrez une information suppl\xE9mentaire concernant ce client"
};
const N76zUg = {
  context: "page header",
  string: "Cr\xE9er un client"
};
const MjUyhA = {
...
const E8VDeH = {
  string: "Num\xE9ro de commandes"
};
const FpIcp9 = {
  string: "Aucun client trouv\xE9"
};
const Gr1SAu = {
...
const RlfqSV = {
  string: "Aucune commande trouv\xE9e"
};
const FNAZoh = {
  string: "Derni\xE8re connexion"
};
const e7Nyu7 = {
  context: "section header",
...
const PXatmC = {
  string: "Client supprim\xE9"
};
const ftcHpD = {
  string: "Client cr\xE9e"
};
const N2SbNc = {
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer ce client?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} clients?}}"
};
const q8ep2I = {
  context: "dialog header",
...
const g3qjSf = {
  context: "button",
  string: "Assigner une cat\xE9gorie"
};
const AbyDC7 = {
  context: "section header",
  string: "Cat\xE9gories \xE9ligibles "
};
const Uu76vj = {
...
const XNeJay = {
  context: "section header",
  string: "Collections \xE9ligibles"
};
const IoCMjg = {
  context: "no collections",
  string: "Aucune collection trouv\xE9e"
};
const ht9yOD = {
  context: "table head",
  string: "Nom de la collection"
...
const wgA48T = {
  ...
  string: "Pays de A \xE0 Z"
};
const AVF5T5 = {
  context: "voucher end date, switch button",
  string: "D\xE9finir une date de fin"
};
const zKOGkU = {
...
const x3g4Ry = {
  ...
  string: "Montant de r\xE9duction"
};
const cehiWu = {
...
const glT6fm = {
  string: "Le bon d'achat est limit\xE9 \xE0 ces pays"
};
const ibnmEd = {
...
const jvKNMP = {
  string: "Code de r\xE9duction"
};
const mSLr9d = {
  context: "voucher code, button",
  string: "G\xE9n\xE9rer un code"
};
const vTgRTZ = {
...
const IruP2T = {
  string: "Rechercher un coupon de r\xE9duction"
};
const GbhZJ4 = {
  context: "button",
  string: "Cr\xE9er un bon d'achat"
...
const U2mOqA = {
  string: "Pas de bons d'achat trouv\xE9s"
};
const GVinbz = {
  context: "column title",
  string: "Valeur"
...
const ObRk1O = {
  string: "Si cette option est d\xE9sactiv\xE9e, le solde sera compt\xE9 pour tout produit \xE9ligible "
};
const bP7ZLP = {
...
const n7Fg8i = {
  string: "Promotion cr\xE9\xE9e avec succ\xE8s"
};
const SqcGBK = {
...
const B5yE8S = {
  context: "dialog header",
  string: "D\xE9sassigner les cat\xE9gories aux promotions"
};
const UjoSZB = {
  context: "dialog content",
...
const rNzkIt = {
  context: "dialog content",
  string: "\xCAtes-vous certain de vouloir supprimer {saleName}?"
};
const opIDox = {
...
const FPzzh7 = {
  context: "dialog content",
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer cette promotion?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} promotions?}}"
};
const Eau5AV = {
  string: "Manage Products Channel Availability"
};
const Q8mpW3 = {
  string: "Bon cr\xE9\xE9 avec succ\xE8s"
};
const MmGlkp = {
  context: "dialog header",
  string: "D\xE9sassigner les collections aux bons"
};
const cNSLLO = {
  context: "button",
  string: "Unassign and save"
...
const cKCfSW = {
  context: "dialog header",
  string: "D\xE9sassigner les produits aux bons"
};
const LOSNq0 = {
  context: "dialog header",
  string: "D\xE9sassigner les cat\xE9gories aux bons"
};
const NEJo1I = {
  context: "dialog content",
  string: "\xCAtes-vous certain de vouloir effacer {voucherCode}?"
};
const EM730i = {
  string: "Manage Channel Availability"
};
...
const O9QPe1 = {
  context: "dialog content",
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer ce bon d'achat?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} bons d'achat?}}"
};
const Q0JJ4F = {
  context: "dialog header",
...
const sjRXXz = {
  string: "La commande #{orderId} a \xE9t\xE9 plac\xE9e \xE0 partir du brouillon par {userEmail}"
};
const BNTZLv = {
  string: "Order #{orderId} was placed from draft"
};
const E9Jssl = {
  string: "Aucune commande pr\xEAte a \xEAtre trait\xE9e"
};
const bFhzRX = {
...
const GLX9II = {
  ...
  string: "M\xEAme adresse que la livraison"
};
const Qovenh = {
...
const mxtAFx = {
  string: "\xCAtes vous certains de vouloir supprimer le brouillon #{orderNumber} "
};
const lVwmf5 = {
...
const KIh25E = {
  string: "Aucun brouillon de commande trouv\xE9"
};
const ps0WUQ = {
  string: "Num\xE9ro de commande"
};
...
const N5UuEK = {
  context: "header",
  string: "Articles pr\xEAts \xE0 \xEAtre exp\xE9di\xE9s"
};
const vW3tb6 = {
  context: "name",
...
const aHc89n = {
  ...
  string: "S\xE9lectionner un entrep\xF4t"
};
const bb4nSp = {
  context: "dialog header",
...
const RLTaAR = {
  ...
  string: "L'adresse de la commande a \xE9t\xE9 mise \xE0 jour"
};
const fkplbE = {
  context: "order history message",
...
const nHmugP = {
  context: "order history message",
  string: "Articles trait\xE9s {quantity} "
};
const GLy2UR = {
  context: "order history message",
  string: "Le traitement a \xE9t\xE9 annul\xE9e"
};
const GJAX0z = {
  context: "order history message",
  string: "La commande a \xE9t\xE9 pass\xE9e"
};
const OzHN0Z = {
  context: "order history message",
  string: "Des liens vers les produits num\xE9riques de la commande ont \xE9t\xE9 envoy\xE9s"
};
const wOeIR4 = {
  context: "order history message",
  string: "{quantity} articles r\xE9approvisionn\xE9s "
};
const oQ27V4 = {
  context: "order history message",
...
const cqZ5UH = {
  context: "order history message",
  string: "La confirmation de commande a \xE9t\xE9 envoy\xE9e au client"
};
const chvryR = {
  context: "order history message",
...
const aq5ZiN = {
  context: "order history message",
  string: "La confirmation de traitement a \xE9t\xE9 envoy\xE9e au client"
};
const hWO1SD = {
  context: "order history message",
  string: "Le brouillon de commande a \xE9t\xE9 cr\xE9\xE9"
};
const j3yE7I = {
  context: "order history message",
  string: "Le num\xE9ro de suivi de la livraison a \xE9t\xE9 envoy\xE9 au client "
};
const U1eJIw = {
  context: "order history message",
...
const e92Uxp = {
  context: "order history message",
  string: "Num\xE9ro de suivi mis \xE0 jour du groupe d'ex\xE9cution"
};
const TCR639 = {
  context: "order history message",
  string: "Paiement refus\xE9 "
};
const BCPrmK = {
  context: "order history message",
  string: "Les d\xE9tails de livraison ont \xE9t\xE9 envoy\xE9s au client "
};
const pTpx0p = {
  context: "order history message",
...
const zRrcOG = {
  context: "order history message",
  string: "La commande a \xE9t\xE9 annul\xE9e"
};
const kVOslW = {
...
const uUsZ7m = {
  context: "order payment",
  string: "Montant pr\xE9-autoris\xE9"
};
const HaQ8cg = {
  context: "button",
...
const c4gbXr = {
  string: "Le brouillon de commande a \xE9t\xE9 finalis\xE9 avec succ\xE8s"
};
const CZmloB = {
  string: "Le traitement a \xE9t\xE9 mise \xE0 jour"
};
const Fn3bE0 = {
  string: "Ligne de commande mise \xE0 jour"
};
const lL1HTg = {
  string: "La commande est marqu\xE9e comme \xE9tant pay\xE9e"
};
const HlCkMT = {
  string: "Ligne de commande ajout\xE9e"
};
const KmPicj = {
  string: "Note ajout\xE9e avec succ\xE8s"
};
const L87bp7 = {
  string: "Le paiement de commande annul\xE9 avec succ\xE8s"
};
const j2fPVo = {
  string: "Commande mise \xE0 jour avec succ\xE8s"
};
const PKJqcq = {
  string: "Invoice is Generating"
};
const uMpv1v = {
  string: "Le traitement a \xE9t\xE9 annul\xE9"
};
const TLNf6K = {
  context: "window title",
...
const ra2O4j = {
  string: "Les brouillons de commandes sont supprim\xE9s "
};
const Q6VRrE = {
  context: "dialog content",
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer ce brouillon de commande?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} brouillons de commande?}}"
};
const CYEnGq = {
...
const gr53VQ = {
  context: "page header",
  string: "Cr\xE9er page"
};
const jZbT0O = {
  string: "Ajouter un titre et une description pour les moteurs de recherche pour rendre cette page plus facile \xE0 trouver"
};
const GZgjK7 = {
  context: "page",
  string: "Sera visible \xE0 partir du {date}"
};
const X26jCC = {
  context: "page label",
  string: "Visible"
...
const JMbFNo = {
  string: "Nouvelle page cr\xE9\xE9e avec succ\xE8s"
};
const C1luwg = {
  context: "dialog header",
...
const yHQQMQ = {
  context: "dialog header",
  string: "Pages non publi\xE9es"
};
const Wd8vG7 = {
  context: "dialog content",
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir d\xE9publier cette page?} other {\xCAtes-vous s\xFBr de vouloir d\xE9publier {displayQuantity} pages?}}"
};
const F8gsds = {
...
const WRPQMM = {
  context: "dialog content",
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir publier cette page?} other {\xCAtes-vous s\xFBr de vouloir publier {displayQuantity} pages?}}"
};
const AzshS2 = {
  context: "notification",
  string: "Pages publi\xE9es"
};
const PbqNhi = {
  context: "order status",
  string: "Partiellement trait\xE9e"
};
const INNPVX = {
  context: "payment status",
  string: "Partiellement pay\xE9"
};
const OGemtu = {
  context: "payment status",
  string: "Partiellement rembours\xE9 "
};
const hLUYBt = {
  context: "payment status",
  string: "Pending"
...
const mAabef = {
  context: "checkbox label",
  string: "Le groupe a un acc\xE8s complet au magasin"
};
const CYZse9 = {
  context: "card description",
...
const CXn88q = {
  string: "Aucun groupe de permissions trouv\xE9"
};
const gVD1os = {
...
const eUjFjW = {
  string: "Groupe de permissions cr\xE9\xE9"
};
const DovGIa = {
  string: "Groupe de permission supprim\xE9"
};
const WhvuCb = {
...
const qCH2eZ = {
  context: "header",
  string: "Ajouter une entr\xE9e au champ d'autorisations"
};
const Egyh2T = {
  context: "section header",
  string: "Param\xE8tres du plugin"
};
const EtGDeK = {
  context: "header",
...
const BtErCZ = {
  string: "Chercher dans les plugins\u2026"
};
const aOelhW = {
  context: "tab name",
...
const JRfJD9 = {
  string: "Le plugin risque de ne plus fonctionner si vous videz ce champ. \xCAtes-vous s\xFBr de vouloir continuer?"
};
const YQ3EXR = {
...
const IBw72y = {
  ...
  string: "Est-ce que produit est exp\xE9diable?"
};
const VOiUXQ = {
  string: "Utilis\xE9 pour calculer les taux pour la livraison de produits de ce type de produit quand aucun poids n'est sp\xE9cifi\xE9 "
};
const zCb8fX = {
  string: "Poids"
};
...
const paa4m0 = {
  string: "Type du produit cr\xE9\xE9 avec succ\xE8s"
};
const F3Upht = {
  string: "Type du produit supprim\xE9 "
};
const UJnqdm = {
  context: "dialog header",
  string: "D\xE9sassigner l'attribut de Type de produit"
};
const r1aQ2f = {
  context: "dialog header",
  string: "D\xE9sassigner l'attribut de Type de produit"
...
const LKoIB1 = {
  string: "Ajouter un titre et une description pour les moteurs de recherche pour rendre cet article plus facile \xE0 trouver"
};
const JGm7E5 = {
  context: "option",
...
const xB7BTp = {
  string: "UGS (Unit\xE9 de Gestion de Stock)"
};
const KTAg0f = {
  context: "tabel column header",
  string: "Nom de l'entrep\xF4t"
};
const NcY4ph = {
...
const cBHRxx = {
  context: "button",
  string: "Attribuer un entrep\xF4t"
};
const REVk27 = {
  context: "info text",
...
const TDXskW = {
  context: "variant attribute",
  string: "S\xE9lectionnez un attribut"
};
const GQcp83 = {
  context: "variant stock, header",
...
const rVaB7c = {
  ...
  string: "S\xE9lectionner des valeurs"
};
const ucYPtV = {
  context: "variant attribute",
...
const lra7Ej = {
  string: "Appliquer le prix unique \xE0 tous les UGS "
};
const J0UdxG = {
  string: "Skip pricing for now"
};
const L5rthO = {
  string: "Appliquer le stock unique par attribut \xE0 chaque UGS "
};
const STp3Hl = {
  string: "Appliquer le stock unique \xE0 tous les UGS "
};
const rHXF43 = {
...
const FSinkL = {
  ...
  string: "Inventaire disponible \xE0:"
};
const HcjV6k = {
  context: "button",
  string: "Cr\xE9er des variantes"
};
const qbqMpk = {
...
const rIJbNC = {
  string: "Utiliser des variantes de produits pour les produits qui ont plusieurs versions par exemple diff\xE9rentes tailles ou couleurs"
};
const JtZ71e = {
  context: "filtering option",
  string: "Tous les entrep\xF4ts"
};
const OTek3r = {
...
const yDkmX7 = {
  context: "dialog content",
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer ce produit?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} produits?}}"
};
const F4WdSO = {
  context: "dialog header",
...
const aI80kg = {
  string: "Propri\xE9t\xE9s"
};
const kFYlu2 = {
  string: "Saleor est en mode lecture seule. Les modifications n\u2019ont pas \xE9t\xE9 sauvegard\xE9es."
};
const rqtV5d = {
  context: "order status",
  string: "Pr\xEAt \xE0 capturer"
};
const oLMXDv = {
  context: "order status",
  string: "Pr\xEAt \xE0 trait\xE9e"
};
const XJSRDK = {
  context: "payment status",
  string: "Totalement rembours\xE9"
};
const nwnwJ0 = {
  context: "payment status",
  string: "Refused"
...
const rqiCWU = {
  string: "Changements enregistr\xE9s "
};
const rfvBAF = {
...
const D9ie4n = {
  ...
  string: "M\xE9thodes de livraison"
};
const nNeWAx = {
  context: "dialog header",
  string: "Supprimer m\xE9thode d'envoi"
};
const aZDHYr = {
...
const AjInNW = {
  context: "dialog description",
  string: "Choisissez les pays que vous voulez ajouter \xE0 la liste des zones de livraison ci-dessous"
};
const f2F1NJ = {
...
const y7mfbl = {
  string: " Actuellement, aucun pays n'est affect\xE9 \xE0 cette zone de livraison"
};
const YpukUN = {
  context: "label",
...
const RUzdUH = {
  string: "Aucun taux de livraison trouv\xE9"
};
const FjrExY = {
  context: "price based shipping methods, section header",
  string: "Taux bas\xE9s sur le prix"
};
const aYhcie = {
...
const foB6wx = {
  ...
  string: "Taux bas\xE9s sur le poids"
};
const aPCrsp = {
...
const mIUNgR = {
  context: "button",
  string: "Cr\xE9er une zone de livraison"
};
const aMwxYb = {
  string: "Pays"
};
const IhK1F3 = {
  string: "Aucune zone de livraison trouv\xE9e"
};
const Gfbp36 = {
  context: "dialog header",
...
const C9pcQx = {
  context: "dialog content",
  string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer cette zone de livraison?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} zones de livraison?}}"
};
const YdeHZX = {
...
const rPX1f2 = {
  context: "section title",
  string: "Informations sur votre entreprise"
};
const LVa5ew = {
  string: "Saleor a rencontr\xE9 un probl\xE8me inattendu "
};
const AQFMYU = {
...
const XMrYaA = {
  context: "checkbox label",
  string: "L'utilisateur est activ\xE9"
};
const YJ4TXc = {
  context: "tab name",
...
const xJQX5t = {
  string: "Aucun membre du personnel trouv\xE9"
};
const cMFlOp = {
  context: "input label",
  string: "Nouveau mot de passe"
...
const qEJT8e = {
  string: "Le nouveau mot de passe doit contenir au moins 8 caract\xE8res"
};
const GXdwyR = {
  context: "input label",
  string: "Mot de passe pr\xE9c\xE9dent"
};
const mm0CXe = {
  string: "Vous devriez changer votre mot de passe tous les mois pour am\xE9liorer la s\xE9curit\xE9."
};
const N3Zot1 = {
  context: "button",
  string: "Modifier votre mot de passe"
};
const ZhDQel = {
  context: "header",
  string: "Mot de passe"
...
const JJgJwi = {
  string: "Changer cette valeur modifiera la langue du tableau de bord"
};
const e822us = {
  string: "Veuillez noter que, bien que toutes les monnaies et param\xE8tres de dates soit disponibles, les traductions de l'interface ne sont que partiellement compl\xE8tes."
};
const mr9jbO = {
  string: "Langue souhait\xE9e"
};
const CLeDae = {
  context: "section header",
  string: "Param\xE8tres"
...
const fzpXvv = {
  string: "\xCAtes-vous certain de vouloir effacer l'avatar de {email}?"
};
const VKWPBf = {
  context: "dialog header",
...
const gxPjIQ = {
  string: "\xCAtes-vous certain de vouloir supprimer {email} des membres du staff?"
};
const QirE3M = {
...
const HtQGEH = {
  string: "Les taux de taxes ont bien \xE9t\xE9 rapatri\xE9s"
};
const u3sYPH = {
...
const FemBUF = {
  context: "header",
  string: "Traductions \xE0 {language}"
};
const CxfKLC = {
  string: "Pages"
};
...
const RzsKm8 = {
  string: "M\xE9thodes d'exp\xE9dition"
};
const c8nvms = {
  string: "Promotions"
};
...
const vcwrgW = {
  string: "Aucune entit\xE9 traduisible trouv\xE9e"
};
const LWmYSU = {
  string: "Traduction compl\xE9t\xE9es"
};
const X6PF8z = {
...
const ptPPVk = {
  string: "Aucune langue trouv\xE9e"
};
const y1Z3or = {
  string: "Langue"
};
...
const Lx1ima = {
  context: "button",
  string: "T\xE9l\xE9charger une image"
};
const m8cjcK = {
...
const IFWHn0 = {
  context: "error message",
  string: "L'adresse de facturation n'est pas d\xE9finie"
};
const ij7olm = {
  context: "error message",
...
const Xb6BJ9 = {
  context: "error message",
  string: "Les paiements manuels ne peuvent pas \xEAtre rembous\xE9s"
};
const WzA5Ll = {
...
const sZ27WU = {
  context: "error message",
  string: " Seuls les paiements pr\xE9-autoris\xE9s peuvent \xEAtre annul\xE9s"
};
const gKdGxP = {
  context: "error message",
  string: "Seuls les paiements pr\xE9-autoris\xE9s peuvent \xEAtre saisis "
};
const V2BBQu = {
...
const VEE4gD = {
  context: "error message",
  string: "La m\xE9thode de livraison est invalide pour l'addresse de livraison choisie"
};
const ychKsb = {
  context: "error message",
...
const rZf1qL = {
  ...
  string: "Les UGSs doivent \xEAtre uniques"
};
const nKjLjT = {
  context: "error message",
  string: "Le slug doit \xEAtre unique pour chaque entrep\xF4t"
};
const wn3di2 = {
  string: "Ce mot de passe est trop couramment utilis\xE9"
};
const LR3HlT = {
  string: "Ce mot de passe est trop court"
};
const TDhHMi = {
  string: "Cela doit \xEAtre unique"
};
const qDwvZ4 = {
...
const Z6QAbw = {
  string: "Cette variante n'a pas de contenu num\xE9rique"
};
const i3Mvj8 = {
  context: "product attribute error",
  string: "Cette variante existe d\xE9j\xE0"
};
const iUy2dx = {
...
const GhcypC = {
  context: "header",
  string: "Cr\xE9er un entrep\xF4t"
};
const DTL7sE = {
  context: "dialog content",
  string: "Etes-vous s\xFBr que vous voulez supprimer {warehouseName}?"
};
const ny4zrH = {
  context: "dialog title",
  string: "Supprimer l'entrep\xF4t"
};
const YkOzse = {
...
const cdiRSf = {
  ...
  string: "Cet entrep\xF4t n'a aucune zone de livraison assign\xE9e."
};
const MIC9W7 = {
...
const X90ElB = {
  context: "dialog header",
  string: "Supprimer le Webhook"
};
const snUby7 = {
  context: "header",
  string: "D\xE9tails du Webhook sans nom"
};
const Ryh3iR = {
  context: "header",
  string: "Cr\xE9er un Webhook"
};
const OPtrMg = {
  context: "header",
  string: "D\xE9tails pour {webhookName}"
};
const QEvH8Q = {
  context: "section description",
...
const tA5HJx = {
  ...
  string: "La cl\xE9 secr\xE8te est utilis\xE9e pour cr\xE9er une signature de hachage pour chaque transfert de donn\xE9es. *Champ optionnel"
};
const WDy0tF = {
  context: "section header",
  string: "Information sur le Webhook"
};
const D0KaT6 = {
  context: "webhook input label",
...
const IBCBi1 = {
  ...
  string: "Si vous voulez d\xE9sactiver ce Webhook d\xE9cochez la case ci-dessous."
};
const wbjuR4 = {
  string: "Aucun Webhook n\u2019a \xE9t\xE9 trouv\xE9"
};
const wlr0Si = {
  context: "button",
  string: "Cr\xE9er un Webhook"
...
const fr = {
  ...
  mDgOmP,
  "19/lwV": {
    string: "D\xE9terminer les attributs utilis\xE9s pour cr\xE9er les types de produits "
  },
  "8vJCJ4": {
  ...
  zxs6G3,
  "5BajZK": {
    string: "Visualiser et mettre \xE0 jour les param\xE8tres de votre site "
  },
  RQUkVW,
  EIULpW,
  "5RmuD+": {
    string: "G\xE9rez et mettez \xE0 jour les informations de votre entrep\xF4t"
  },
  m19JfL,
  yJynYK,
  ojHyj3,
  ...
  "0opVvi": {
    ...
    string: "{amount, plural,one {Un command\xE9} other {{amount} command\xE9s}}"
  },
  rr8fyf,
  Q1Uzbb,
  "6L6Fy2": {
  ...
  "5LRkEs": {
    string: "Le nouveau tableau de bord et l'API GraphQL sont des logiciels de qualit\xE9."
  },
  G7mu0y,
  QBxN6z,
  "I+UwqI": {
  ...
  "G/SYtU": {
    string: "\xCAtes-vous certain de vouloir supprimer le menu {menuName}?"
  },
  QzseV7,
  E54eoT,
  H3Uirw,
  ...
  Urh2N3,
  "28GZnc": {
    string: "Commencez \xE0 taper pour d\xE9buter la recherche..."
  },
  "0Vyr8h": {
  ...
  bj1U23,
  "svK+kv": {
    string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer ce menu?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} menus?}}"
  },
  "1LBYpE": {
    context: "dialog header",
  ...
  "OwG/0z": {
    string: "Le menu est supprim\xE9"
  },
  "0nL1D6": {
  ...
  "6y+k8V": {
    context: "product field",
    string: "Images du produit"
  },
  "7JAAul": {
    context: "product field",
    string: "Exporter le poids du produit"
  },
  QVNg8A,
  "Q/Nbku": {
    context: "product field",
  ...
  "D/+84n": {
    context: "snackbar text",
    string: "L'application est active"
  },
  USO8PB,
  YHNozE,
  Q47ovw,
  ...
  "6hLZNA": {
    context: "delete app",
    string: "\xCAtes-vous s\xFBr de vouloir supprimer cette application?"
  },
  "EWD/wU": {
    context: "delete app",
  ...
  "906uUr": {
    context: "button",
    string: "Retour \xE0 la page d'acceuil"
  },
  k5lHFp,
  PkCmGU,
  "BL/Lbk": {
  ...
  "HVFq//": {
    context: "button",
    string: "Copier la cl\xE9 d'acc\xE8s"
  },
  ixjvkM,
  imYxM9,
  foNlhn,
  ...
  RMB6fU,
  "0DRBjg": {
    string: "Note de la cl\xE9 d'acc\xE8s"
  },
  VHuzgq,
  XB2Jj9,
  voRaz3,
  ...
  "9tgY4G": {
    ...
    string: "Vous n'avez aucune application install\xE9e sur votre dashboard"
  },
  ZeD2TK,
  SwISVH,
  NskBjH,
  ...
  "2VSP8C": {
    ...
    string: "\xCAtes-vous certain de vouloir supprimer la cl\xE9 d'acc\xE8s {token}?"
  },
  "ac+Y98": {
    context: "app settings error",
    string: "Impossible de recevoir les param\xE8tres de l'application"
  },
  "2cjt25": {
    context: "window title",
    string: "Installer l'application"
  ...
  "5t/4um": {
    ...
    string: "Impossible d'installer {name}"
  },
  "0fM/pV": {
    context: "message title",
    string: "Application install\xE9e"
  },
  ZprV2g,
  uIPD1i,
  agZQkB,
  ...
  eWV760,
  "J/QqOI": {
    string: "Cette valeur existe d\xE9j\xE0 dans cet attribut"
  },
  "lG/MDw": {
    context: "dialog content",
    string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer cet attribut?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} attributs?}}"
  },
  rKf4LU,
  JI2Xwp,
  h1rPPg,
  ...
  "PsRG+v": {
    ...
    string: "Filtrable dans la boutique"
  },
  rvk9ls,
  HQR2y0,
  cvbqJu,
  ...
  "8cUEPV": {
    context: "page title",
    string: "Cr\xE9er nouvel attribut"
  },
  jswILH,
  AzMSmb,
  lCxfDe,
  ...
  NUevU9,
  "jTifz+": {
    string: "Attribut cr\xE9\xE9 avec succ\xE8s"
  },
  "7H2D5m": {
    context: "attribute value deleted",
    string: "Valeur supprim\xE9e "
  },
  "V/VAHG": {
    string: "Attribut supprim\xE9"
  },
  xVn5B0,
  lw9WIk,
  vzgZ3U,
  ...
  lm9NSK,
  "Yy/yDL": {
    string: "R\xE9initialiser le mot de passe"
  },
  "54M0Gu": {
  ...
  "2oyWT9": {
    context: "button",
    string: "Retour \xE0 la connexion "
  },
  "2ob30/": {
    string: "R\xE9ussi! Dans quelques minutes vous recevrez un message avec les instructions pour red\xE9finir votre mot-de-passe."
  },
  C0JLNW,
  hOxIeP,
  "0OfZJA": {
  ...
  "cgsY/X": {
    context: "page header",
    string: "Cr\xE9er nouvelle cat\xE9gorie"
  },
  wQdR8M,
  xo5UIb,
  dJQxHt,
  vEYtiq,
  "8HRy+U": {
    string: "Description de la cat\xE9gorie"
  },
  vof5TR,
  JiXNEV,
  vy7fjd,
  ...
  xl7Fag,
  "Pp/7T7": {
    string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer cette cat\xE9gorie?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} cat\xE9gories?}}"
  },
  HvJPcU,
  KCjd1o,
  "3DGvA/": {
  ...
  "e+L+q3": {
    string: "Souvenez-vous que cela va aussi supprimer tous les produits assign\xE9s \xE0 cette cat\xE9gorie."
  },
  sG0w22,
  xRkj2h,
  KeO51o,
  ...
  Q8wHwJ,
  "56vUeQ": {
    string: "Le produit a \xE9t\xE9 ajout\xE9 \xE0 la collection"
  },
  MxhVZv,
  "AulH/n": {
    string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir d\xE9-assigner ce produit?} other {\xCAtes-vous s\xFBr de vouloir d\xE9-assigner {displayQuantity} produits?}}"
  },
  "WW+Ruy": {
    string: "Le produit est supprim\xE9 de la collection"
  },
  I1Mz7h,
  "5OtU+V": {
    context: "dialog title",
    string: "D\xE9sassigner les produits \xE0 la collection"
  },
  pVFoOk,
  ttMauu,
  "+wpvnk": {
  ...
  "EM+30g": {
    ...
    string: "La nouvelle fonctionnalit\xE9 pour vous aider dans vos t\xE2ches quotidiennes. Lancez le navigateur en utilisant le raccourci {keyboardShortcut}."
  },
  me585h,
  Gxm7Qx,
  ccXLVi,
  ...
  "3TlhJS": {
    ...
    string: "Rechercher une action"
  },
  DHBlFi,
  "Xel9C+": {
    context: "navigator default mode description",
    string: "Chercher dans les vues et les actions"
  },
  iAvKNf,
  usSkzP,
  k8bltk,
  ...
  bj6pTd,
  "nRiOg+": {
    string: "D\xE9sol\xE9, la page n'a pas \xE9t\xE9 trouv\xE9e"
  },
  "95oJ5d": {
    context: "button",
  ...
  ChAjJu,
  "s/sTT6": {
    string: "Si le champ est vide, la pr\xE9visualisation montre ce qui sera g\xE9n\xE9r\xE9 automatiquement."
  },
  "450Fty": {
    string: "Aucun"
  },
  "qu/hXD": {
    string: "{number} objets s\xE9lectionn\xE9"
  },
  "2HfSiT": {
    context: "pagination",
    string: "No. of rows"
  ...
  "X8+Lpa": {
    context: "button",
    string: "Param\xE8tres du compte"
  },
  "2r4cTE": {
    context: "button",
  ...
  "UN+yTt": {
    string: "Param\xE8tres du personnel"
  },
  HjXnIf,
  jFrdB5,
  MWSacl,
  ...
  MpR4zK,
  "y/UWBR": {
    string: "Il n'y a pas d'adresse \xE0 afficher pour ce client"
  },
  CWqmRU,
  hMRP6J,
  VyzsWZ,
  ...
  "+7OsyM": {
    context: "button",
    string: "D\xE9finir comme adresse de livraison par d\xE9faut"
  },
  BfJGij,
  Zd3Eew,
  bHdFph,
  ...
  FNAZoh,
  "HMD+ib": {
    string: "Derni\xE8re commande"
  },
  e7Nyu7,
  "2p0tZx": {
    context: "delete customer, dialog content",
    string: "\xCAtes-vous certain de vouloir effacer l'email {email}?"
  },
  ey0lZj,
  qLOBff,
  nX2pCU,
  "/kWzY1": {
    string: "\xCAtes-vous certain de vouloir supprimer cette adresse du carnet d'adresses des utilisateurs?"
  },
  PXatmC,
  ftcHpD,
  N2SbNc,
  ...
  dGqEJ9,
  "dWK/Ck": {
    string: "Choisissez les pays auxquels vous souhaitez que le bon d'achat soit limit\xE9 dans la liste ci-dessous"
  },
  "8EGagh": {
  ...
  "/oyr6M": {
    context: "no variants",
    string: "Aucune variation trouv\xE9e"
  },
  Q1HhPk,
  lHccsy,
  "2E1xZ0": {
  ...
  giF5UV,
  "51HE+Q": {
    string: "Aucune promotion trouv\xE9e"
  },
  iBSq6l,
  "WkxE8/": {
  ...
  YjcN9w,
  "jd/LWa": {
    string: "Le bon d'achat s'applique \xE0 tous les pays"
  },
  glT6fm,
  ibnmEd,
  jvKNMP,
  ...
  "Qj/3sH": {
    context: "limit voucher",
    string: "Limiter le nombre de fois que cette r\xE9duction peut \xEAtre utilis\xE9e au total "
  },
  "+jHXT3": {
    context: "limit voucher",
  ...
  "XT/ZvF": {
    ...
    string: "La quantit\xE9 minimale d'articles "
  },
  "bh9+8A": {
    context: "voucher requirement",
  ...
  "9UHfux": {
    string: "Informations sp\xE9cifiques du bon"
  },
  ObRk1O,
  bP7ZLP,
  "45zP+r": {
    context: "voucher discount",
    string: "Des produits sp\xE9cifiques"
  },
  WasHjQ,
  n7Fg8i,
  "ESDTC/": {
  ...
  BNTZLv,
  "5SPHkk": {
    string: "La commande #{orderId} a \xE9t\xE9 enti\xE8rement pay\xE9e"
  },
  "0dPP8O": {
    string: "La commande #{orderId} a \xE9t\xE9 plac\xE9e"
  },
  "Nuq83+": {
  ...
  NJbzcP,
  "i+JSEZ": {
    string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir annuler cette commande?} other {\xCAtes-vous s\xFBr de vouloir annuler {displayQuantity} commandes?}}"
  },
  VSztEE,
  NhQboB,
  "b+jcaN": {
  ...
  "9gb9b4": {
    context: "address type",
    string: "Ajouter une nouvelle adresse"
  },
  Qph0GE,
  xWEFrR,
  "kQq6/o": {
  ...
  "UD7/q8": {
    string: "Aucun produit ajout\xE9 \xE0 la commande"
  },
  lVwmf5,
  Myx1Qp,
  BjxQ3u,
  ...
  "4PlW0w": {
    ...
    string: "Num\xE9ro de suivi: {trackingNumber}"
  },
  EHsnZX,
  SqhC7g,
  UQu75k,
  ...
  "OKGd/k": {
    context: "order history message",
    string: "La commande a \xE9t\xE9 cr\xE9\xE9e depuis le brouillon"
  },
  "4Z6BtA": {
    context: "order history message",
    string: "La confirmation de paiement a \xE9t\xE9 envoy\xE9e au client "
  },
  wOeIR4,
  "6WRFp2": {
    context: "order history message",
    string: "La note a \xE9t\xE9 ajout\xE9e \xE0 la commande"
  },
  oQ27V4,
  cqZ5UH,
  chvryR,
  "8RnPGF": {
    context: "order history message",
    string: "Le paiement a \xE9t\xE9 annul\xE9"
  },
  fehqPs,
  "P/EDn1": {
    context: "order history message",
    string: "La commande a \xE9t\xE9 enti\xE8rement pay\xE9e"
  },
  ubasgL,
  "2yV+s8": {
    context: "order history message",
    string: "Le paiement a \xE9t\xE9 captur\xE9 "
  },
  aq5ZiN,
  hWO1SD,
  "GVM/fi": {
  ...
  "3fgyFh": {
    context: "order history message",
    string: "Le paiement a \xE9t\xE9 rembours\xE9"
  },
  "D3WUc/": {
    context: "order history message",
  ...
  "+B25o/": {
    context: "dialog header",
    string: "Marquer la commande comme \xE9tant pay\xE9e"
  },
  "+PbHKD": {
    context: "dialog header",
  ...
  OhdPS1,
  "euRfu+": {
    string: "\xCAtes-vous certain de vouloir annuler ce paiement ?"
  },
  KszPFx,
  BZ7BkQ,
  "V+gwx7": {
  ...
  "V/YxJa": {
    context: "dialog header",
    string: "Modifier la m\xE9thode de livraison"
  },
  "/Xwjww": {
    context: "button",
    string: "Traiter"
  ...
  "9RCuN3": {
    string: "Paiement captur\xE9 avec succ\xE8s"
  },
  c4gbXr,
  "9OtpHt": {
    string: "Ligne de commande supprim\xE9e"
  },
  CZmloB,
  Fn3bE0,
  lL1HTg,
  HlCkMT,
  "W/Es0H": {
    string: "Commande supprim\xE9e avec succ\xE8s"
  },
  KmPicj,
  L87bp7,
  j2fPVo,
  ...
  PKJqcq,
  "7U8GRy": {
    string: "La m\xE9thode de livraison a \xE9t\xE9 mise \xE0 jour avec succ\xE8s"
  },
  uMpv1v,
  TLNf6K,
  GbBCmr,
  ...
  ra2O4j,
  "6udlH+": {
    string: "Brouillon de commande cr\xE9\xE9 avec succ\xE8s"
  },
  Q6VRrE,
  "2MKBk2": {
    context: "window title",
  ...
  "4B32Ba": {
    context: "delete page",
    string: "\xCAtes-vous certain de vouloir effacer {title}?"
  },
  "41z2Qi": {
    context: "notification",
    string: "Pages supprim\xE9es"
  },
  yEmwxD,
  yHQQMQ,
  Wd8vG7,
  ...
  "UNwG+4": {
    context: "dialog content",
    string: "{counter,plural,one {\xCAtes-vous s\xFBr de vouloir supprimer cette page?} other {\xCAtes-vous s\xFBr de vouloir supprimer {displayQuantity} pages?}}"
  },
  AzshS2,
  "3Sz1/t": {
    context: "dialog header",
  ...
  "2pw5dQ": {
    context: "payment status",
    string: "Paiement totalement effectu\xE9"
  },
  PbqNhi,
  INNPVX,
  OGemtu,
  ...
  "Xy2T+y": {
    context: "header",
    string: "Modifier le champ d'autorisation"
  },
  Egyh2T,
  EtGDeK,
  BtErCZ,
  ...
  "N6lfS/": {
    context: "header",
    string: "Supprimer le champ d'autorisation"
  },
  JRfJD9,
  "6QjMei": {
  ...
  "0nLsyM": {
    string: "Aucun type de produit trouv\xE9"
  },
  "yNb+dT": {
    context: "product type",
  ...
  "v+Pkm+": {
    context: "field is optional",
    string: "*Optionnel. Ajouter un produit \xE0 une collection aide l'utilisateur \xE0 le trouver."
  },
  anK7jD,
  "3rIMq/": {
  ...
  L5rthO,
  "EGG8f+": {
    string: "Appliquer les prix uniques par attribut \xE0 chaque UGS "
  },
  STp3Hl,
  "+bFHzi": {
    context: "button",
  ...
  T6dXGG,
  "VEext+": {
    string: "\xCAtes-vous certain de vouloir supprimer cette image?"
  },
  MyM2oR,
  PXx4Jk,
  NBP8uu,
  "DO8+uV": {
    string: "Produit cr\xE9\xE9"
  },
  yDkmX7,
  "5QKsu+": {
  ...
  "5ZvuVw": {
    string: "Aucun produit ne correspond \xE0 la demande"
  },
  FzEew9,
  xZhxBJ,
  "Gg4+K7": {
  ...
  FkDObY,
  "4Kq3O6": {
    string: "Cette unit\xE9 sera utilis\xE9e comme poids de livraison par d\xE9faut"
  },
  "Rp/Okl": {
    string: "Unit\xE9 du poids de la livraison "
  },
  "llBnr+": {
    string: "Nom de l'entrep\xF4t"
  },
  "yzYXW/": {
    ...
    string: "Cr\xE9er un nouvel entrep\xF4t"
  },
  "LHPVg/": {
  ...
  "G+9nOZ": {
    ...
    string: "Si s\xE9lectionn\xE9, cela ajoutera tous les pays non-s\xE9lectionn\xE9s aux autres zones de livraison"
  },
  pGDYG5,
  "1rpzrM": {
  ...
  "6fxdUO": {
    context: "section header",
    string: "Cr\xE9er nouvelle zone d'envoi"
  },
  y7mfbl,
  "G0+gAp": {
  ...
  "n25d+d": {
    ...
    string: "Ajouter un nouvel entrep\xF4t"
  },
  "/cow4T": {
  ...
  pwqwcy,
  "qf/m5l": {
    string: "\xCAtes-vous certain de vouloir supprimer {shippingZoneName} de la zone de livraison?"
  },
  "k3EI/U": {
    context: "dialog header",
  ...
  lnQAos,
  "3BTtL2": {
    string: "Aucun pays trouv\xE9"
  },
  "/JENWS": {
    string: "Taux de taxe r\xE9duit "
  },
  "07KB2d": {
    string: "Code du pays"
  },
  ...
  QHB48n,
  "Ubath+": {
    string: "Aucune cat\xE9gorie de taxe r\xE9duite trouv\xE9e"
  },
  "4EuJKs": {
  ...
  QUyUJy,
  "bh+Keo": {
    string: "{numberOfFields} traductions, {numberOfTranslatedFields} pr\xEAtes"
  },
  Xtd0AT,
  "/vCXIP": {
    string: "Traduction"
  ...
  US3IPU,
  "XitW/z": {
    string: 'Traduction de la cat\xE9gorie "{categoryName}" - {languageCode}'
  },
  HlEpii,
  Bphmwe,
  GsBRWL,
  ...
  m8cjcK,
  "+x4cZH": {
    string: "Seuls les membres du personnel peuvent \xEAtre affect\xE9s"
  },
  aggaJg,
  u24Ppd,
  cd13nN,
  ...
  PFXGaR,
  "2gsiR1": {
    string: "Aucun entrep\xF4t trouv\xE9"
  },
  aCJwVq,
  "16PGt9": {
  ...
  "0MetrR": {
    context: "webhook input help text",
    string: "Cette URL recevra des requ\xEAtes Webhook de type POST"
  },
  WDy0tF,
  D0KaT6,
  "W+x5ZI": {
    context: "webhooks active label",
    string: "Le Webhook est actif"
  },
  IBCBi1,
  "1+M/52": {
    context: "section header",
    string: "Status du Webhook"
  },
  wbjuR4,
  wlr0Si,
  jqnwW9,
...
//# sourceMappingURL=fr.b8910ea9.js.map
